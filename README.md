...
A [demo notebook](demo/plotmap_demo.ipynb) shows some examples of the code's use using [ERA5](https://www.ecmwf.int/en/forecasts/dataset/ecmwf-reanalysis-v5) reanalysis data.
